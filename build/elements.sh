...
eval_echo "$MVNW clean compile exec:java -Dfile.encoding=UTF-8 -Dexec.mainClass=com.codenjoy.dojo.services.generator.ElementGeneratorRunner -Dexec.args='$BASE $GAMES $CLIENTS $LOCALE'"
